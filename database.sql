...
END;
$$ LANGUAGE plpgsql SECURITY DEFINER SET search_path = public, pg_temp; SET search_path = public, pg_temp; SET search_path = public, pg_temp; SET search_path = public, pg_temp;
...
-- ==========================================
-- 5. THIRD-PARTY SELLER & MARKETPLACE TABLES
-- ==========================================
