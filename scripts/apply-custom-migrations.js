// scripts/apply-custom-migrations.js
...
async function run() {
  console.log('--- Custom Database Migration Runner ---');
  ...
  try {
    ...
    const migrationPath = path.resolve('supabase/migrations/20260701200000_create_custom_webhook_tunnel.sql');
    console.log(`Reading migration file: ${migrationPath} ...`);
    const sql = fs.readFileSync(migrationPath, 'utf8');

    console.log('Executing SQL migration...');
    await client.query(sql);
    console.log('✅ SQL migration executed successfully. Table "custom_webhook_tunnel_queue" created and Realtime enabled.');
