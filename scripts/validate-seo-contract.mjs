...
const PUBLIC_ROUTES = [
  ...
  { path: '/about', file: 'about/page.tsx', jsonLd: ['AboutPage'], inSitemap: true },
  { path: '/about/business-info', file: 'about/business-info/page.tsx' },
  { path: '/assessment', file: 'assessment/page.tsx', inSitemap: true },
  { path: '/blog', file: 'blog/page.tsx', jsonLd: ['Blog'], inSitemap: true },
  { path: '/blog/[slug]', file: 'blog/[slug]/page.tsx', jsonLd: ['BlogPosting'], breadcrumb: true },
  { path: '/blueprints/[id]', file: 'blueprints/[id]/page.tsx' },
  { path: '/contact', file: 'contact/page.tsx', jsonLd: ['ContactPage'], faq: true, inSitemap: true },
  { path: '/customised-setups', file: 'customised-setups/page.tsx', inSitemap: true },
  ...
  { path: '/info/faqs', file: 'info/faqs/page.tsx', faq: true },
  { path: '/info/policies', file: 'info/policies/page.tsx' },
  { path: '/info/policies/cookie', file: 'info/policies/cookie/page.tsx' },
  { path: '/info/policies/privacy', file: 'info/policies/privacy/page.tsx' },
  { path: '/info/policies/refund-cancellation', file: 'info/policies/refund-cancellation/page.tsx' },
  { path: '/info/policies/return', file: 'info/policies/return/page.tsx' },
  { path: '/info/policies/shipping', file: 'info/policies/shipping/page.tsx' },
  { path: '/info/policies/terms', file: 'info/policies/terms/page.tsx' },
  { path: '/offers', file: 'offers/page.tsx', inSitemap: true },
  { path: '/portfolio', file: 'portfolio/page.tsx', inSitemap: true },
  { path: '/products', file: 'products/page.tsx', jsonLd: ['CollectionPage'], inSitemap: true },
  { path: '/products/[id]', file: 'products/[id]/page.tsx', jsonLd: ['Product'], breadcrumb: true },
  { path: '/resources', file: 'resources/page.tsx', inSitemap: true },
  ...
  { path: '/solutions', file: 'solutions/page.tsx', layoutFile: 'solutions/layout.tsx', inSitemap: true },
  { path: '/webdev', file: 'webdev/page.tsx', inSitemap: true },
  { path: '/ai-research', file: 'ai-research/page.tsx', layoutFile: 'ai-research/layout.tsx' },
  { path: '/agents/recruit', file: 'agents/recruit/page.tsx' },
];
