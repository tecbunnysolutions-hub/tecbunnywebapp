...
export const PERMS = {
  ...
  INTEGRATIONS_API_USE: 'integrations:api:use',
  INTEGRATIONS_API_KEYS_MANAGE: 'integrations:api-keys:manage',
  INTEGRATIONS_WEBHOOKS_MANAGE: 'integrations:webhooks:manage',
  INTEGRATIONS_CONFIGURE: 'integrations:configure',
  INTEGRATIONS_API_LOGS_VIEW: 'integrations:api-logs:view',
  INTEGRATIONS_SECRETS_ROTATE: 'integrations:secrets:rotate',
  INTEGRATIONS_DEV_PORTAL_ACCESS: 'integrations:developer-portal:access',
  INTEGRATIONS_ALL: 'integrations:all',

  RELEASE_TEST_SUITE_RUN: 'release:test-suite:run',
  RELEASE_DEPLOY_STAGING: 'release:deploy:staging',
  RELEASE_DEPLOY_PRODUCTION: 'release:deploy:production',
  RELEASE_ROLLBACK: 'release:rollback',
  RELEASE_PRODUCTION_LOGS_VIEW: 'release:production-logs:view',
  RELEASE_MONITORING_MANAGE: 'release:monitoring:manage',
  RELEASE_GOLIVE_APPROVE: 'release:golive:approve',
...
const DIRECT_PERMISSIONS: Record<AuthorizationRole, readonly Permission[]> = {
  ...
  sales_executive: [PERMS.CRM_WRITE, PERMS.ORDERS_CREATE, PERMS.INTEGRATIONS_API_USE],
  store_executive: [PERMS.ORDERS_UPDATE, PERMS.BILLING_QUICK, PERMS.INTEGRATIONS_API_USE],
  sales_agent: [PERMS.ORDERS_CREATE_DELEGATE, PERMS.COMMISSION_READ, PERMS.INTEGRATIONS_API_USE],
  service_engineer: [PERMS.SERVICES_UPDATE_OWN, PERMS.REPORTS_SUBMIT, PERMS.INTEGRATIONS_API_USE],
  support: [PERMS.SUPPORT_TICKETS_READ, PERMS.SUPPORT_TICKETS_WRITE, PERMS.INTEGRATIONS_API_USE, PERMS.RELEASE_TEST_SUITE_RUN],
  delivery: [PERMS.DELIVERY_READ, PERMS.DELIVERY_UPDATE, PERMS.INTEGRATIONS_API_USE],
  warehouse: [PERMS.INVENTORY_READ, PERMS.INVENTORY_UPDATE, PERMS.ORDERS_DISPATCH, PERMS.INTEGRATIONS_API_USE],
  hr: [PERMS.USERS_MANAGE, PERMS.INTEGRATIONS_API_USE, PERMS.INTEGRATIONS_API_LOGS_VIEW, PERMS.INTEGRATIONS_DEV_PORTAL_ACCESS],
  marketing_executive: [PERMS.PRODUCTS_UPDATE, PERMS.CRM_READ, PERMS.MARKETING_READ, PERMS.MARKETING_WRITE, PERMS.INTEGRATIONS_API_USE],
  marketing_manager: [PERMS.MARKETING_APPROVE, PERMS.REPORTS_READ, PERMS.INTEGRATIONS_API_USE, PERMS.INTEGRATIONS_API_LOGS_VIEW, PERMS.INTEGRATIONS_DEV_PORTAL_ACCESS],
  accounts: [PERMS.BILLING_INVOICE_MANAGE, PERMS.REPORTS_READ, PERMS.INTEGRATIONS_API_USE, PERMS.INTEGRATIONS_API_LOGS_VIEW, PERMS.INTEGRATIONS_DEV_PORTAL_ACCESS],
  sales_manager: [
    PERMS.USERS_READ_TEAM,
    PERMS.ORDERS_DISPATCH_AREA,
    PERMS.CRM_ASSIGN_AREA,
    PERMS.REPORTS_READ,
    PERMS.INTEGRATIONS_API_USE,
    PERMS.INTEGRATIONS_API_LOGS_VIEW,
    PERMS.INTEGRATIONS_DEV_PORTAL_ACCESS,
    PERMS.RELEASE_TEST_SUITE_RUN,
    PERMS.RELEASE_DEPLOY_STAGING,
    PERMS.RELEASE_ROLLBACK,
    PERMS.RELEASE_PRODUCTION_LOGS_VIEW,
    PERMS.RELEASE_MONITORING_MANAGE,
  ],
  service_manager: [
    PERMS.USERS_READ_TEAM,
  ...
  admin: [
    ...
    PERMS.REPORTS_ALL,
    PERMS.INTEGRATIONS_API_USE,
    PERMS.INTEGRATIONS_API_KEYS_MANAGE,
    PERMS.INTEGRATIONS_WEBHOOKS_MANAGE,
    PERMS.INTEGRATIONS_CONFIGURE,
    PERMS.INTEGRATIONS_API_LOGS_VIEW,
    PERMS.INTEGRATIONS_DEV_PORTAL_ACCESS,
    PERMS.RELEASE_TEST_SUITE_RUN,
    PERMS.RELEASE_DEPLOY_STAGING,
    PERMS.RELEASE_DEPLOY_PRODUCTION,
    PERMS.RELEASE_ROLLBACK,
    PERMS.RELEASE_PRODUCTION_LOGS_VIEW,
    PERMS.RELEASE_MONITORING_MANAGE,
    PERMS.RELEASE_GOLIVE_APPROVE,
  ],
  superadmin: [
    PERMS.PRODUCTS_ALL,
    PERMS.ORDERS_ALL,
    ...
    PERMS.SYSTEM_ALL,
    PERMS.AI_ALL,
    PERMS.INTEGRATIONS_ALL,
    PERMS.INTEGRATIONS_SECRETS_ROTATE,
    PERMS.RELEASE_ALL,
  ],
};
