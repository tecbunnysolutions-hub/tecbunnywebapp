...
export type OrderStatus = 'Pending' | 'Awaiting Payment' | 'Payment Confirmed' | 'Payment Failed' | 'Confirmed' | 'Processing' | 'Ready to Ship' | 'Shipped' | 'Ready for Pickup' | 'Ready for Delivery' | 'Delivered' | 'Delivered/Picked Up' | 'Completed' | 'Cancelled' | 'Rejected' | 'On Hold' | 'Visit Scheduled' | 'Visit Completed' | 'Diagnosis Done' | 'Quote Sent' | 'Awaiting Customer Approval' | 'Approved' | 'Parts Ordered' | 'Work In Progress' | 'Quality Check' | 'Warranty/Support Active';
...
export type ContactMessageStatus = 'New' | 'Assigned' | 'Contacted' | 'In Progress' | 'Resolved' | 'Closed' | 'Rejected';
...
export type ServiceTicketStatus = 'created' | 'accepted' | 'rejected' | 'under_process' | 'hold_for_product_payment' | 'rejected_by_customer' | 'completed';
