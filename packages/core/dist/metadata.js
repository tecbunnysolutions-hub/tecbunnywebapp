...
export async function cleanMetadataTitle(value) {
...
export async function cleanMetadataDescription(value) {
    const settings = await getAppSettings();
...
export async function createPageMetadata({ title, description, path, image, keywords = [], openGraph, twitter, }) {
    const settings = await getAppSettings();
