 ...
 */
export async function optimizeImage(inputBuffer, options = { maxWidth: 1920, maxHeight: 1920 }) {
    try {
 ...
 */
export function createOptimizeImageStream(options = { maxWidth: 1920, maxHeight: 1920 }) {
    return sharp()
        .resize({
        width: options.maxWidth,
        height: options.maxHeight,
 ...
 */
export async function processAndUploadExternalImage(url, supabase) {
