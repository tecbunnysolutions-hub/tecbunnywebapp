export function computeAutoFill(productsList, salesCounts, options) {
    ...
    const deals = [...products]
        .filter(prod => (typeof prod.offer_price === 'number' && prod.offer_price < prod.price) || prod.discount_percentage > 0)
        .sort((a, b) => {
