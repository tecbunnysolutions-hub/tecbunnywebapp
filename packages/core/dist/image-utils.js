 ...
 */
export function getFirstValidImage(imageArray) {
 ...
 */
export function filterValidImages(imageArray) {
    if (!Array.isArray(imageArray))
        return [];
    return imageArray
 ...
 */
export function getProductDisplayImage(product, _options = {}) {
 ...
 */
export function cleanupProductImages(product) {
