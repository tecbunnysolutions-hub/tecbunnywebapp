...
export const couponsRouter = router({
  ...
  update: protectedProcedure
    ...
    .mutation(async ({ input }: { input: any }) => {
      ...
      if (input.applicable_category !== undefined) updateData.applicable_category = input.applicable_category;
      if (input.applicable_product_id !== undefined) updateData.applicable_product_id = input.applicable_product_id;
