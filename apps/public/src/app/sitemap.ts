...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes = [
    ...
    {
      url: `${baseUrl}/services/computers-mobiles`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.9,
    },
    {
      url: `${baseUrl}/services/networking-internet`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.9,
    },
    {
      url: `${baseUrl}/services/cctv-security`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.9,
    },
    ...
    {
      url: `${baseUrl}/industries/offices`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },
    ...
    {
      url: `${baseUrl}/resources/infrastructure-planning-guide`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },
    {
      url: `${baseUrl}/resources/cctv-planning-guide`,
      lastModified: now,
      changeFrequency: 'monthly' as const,
      priority: 0.8,
    },
