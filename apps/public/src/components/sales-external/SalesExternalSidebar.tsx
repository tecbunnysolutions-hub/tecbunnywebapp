...
const navItems = [
  ...
  { href: '/mgmt/sales-external/quick-billing', label: 'Quick Billing', icon: Zap },
  { href: '/mgmt/sales-external/commission-report', label: 'Commission Report', icon: DollarSign },
  { href: '/mgmt/sales-external/reports', label: 'Reports', icon: BarChart2 },
];
...
export function SalesExternalSidebar() {
  ...
  const mobileSections = [{ title: 'External Sales', items: navItems }];

  return (
    <>
    <MgmtMobileNav title="External Sales" sections={mobileSections} />
