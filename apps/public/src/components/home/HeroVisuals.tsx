...
export function HeroVisuals() {
  return (
    <div className="reveal-section is-revealed relative block mt-8 lg:mt-0" data-reveal-id="hero-visual" id="hero-visual">
      <div className="hero-status-panel tb-panel group relative z-10 overflow-hidden p-6 sm:p-8">
